...
switch (true) do {
	...
	case (_value > 100 && _value <= 150) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2, 80], ["SOLDIERS_AT_HEAVY", 2, 50], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 70], ["SOLDIERS_SPECOPS", 1]], [["VEHICLES_LIGHT", 1, 35], ["SOLDIERS_SNIPERS", 1, 75], ["VEHICLES_MEDIUM", 1, 33], ["VEHICLES_HEAVY", 1, 25], ["VEHICLES_AA_LIGHT", 1, 22]]];
	};
	case (_value > 150 && _value <= 200) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2, 70], ["SOLDIERS_AT_MEDIUM", 2, 65], ["SOLDIERS_AT_HEAVY", 2, 60], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 80]], [["VEHICLES_LIGHT", 1, 40], ["VEHICLES_MEDIUM", 1, 33], ["VEHICLES_HEAVY", 1, 27], ["VEHICLES_AA_LIGHT", 1, 25]]];
	};
	case (_value > 200 && _value <= 250) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2, 55], ["SOLDIERS_AT_MEDIUM", 2, 65], ["SOLDIERS_AT_HEAVY", 2, 65], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 85]], [["VEHICLES_LIGHT", 1, 37], ["VEHICLES_MEDIUM", 1, 35], ["VEHICLES_HEAVY", 1, 30], ["VEHICLES_AA_LIGHT", 1, 27]]];
	};
	case (_value > 250 && _value <= 300) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2, 50], ["SOLDIERS_AT_MEDIUM", 2, 70], ["SOLDIERS_AT_HEAVY", 2, 70], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 90]], [["VEHICLES_LIGHT", 1, 45], ["VEHICLES_MEDIUM", 1, 37], ["VEHICLES_HEAVY", 1, 33], ["VEHICLES_AA_LIGHT", 1, 30]]];
	};
	case (_value > 300 && _value <= 350) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 3, 45], ["SOLDIERS_AT_MEDIUM", 3, 75], ["SOLDIERS_AT_HEAVY", 3, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 95]], [["VEHICLES_LIGHT", 1, 55], ["VEHICLES_MEDIUM", 1, 40], ["VEHICLES_HEAVY", 1, 35], ["VEHICLES_AA_LIGHT", 1, 30]]];
	};
	case (_value > 350 && _value <= 400) : {
		_pool_units = [[["SOLDIER", 4], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 3, 40], ["SOLDIERS_AT_MEDIUM", 3, 80], ["SOLDIERS_AT_HEAVY", 3, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 3], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 2]], [["VEHICLES_LIGHT", 1, 55], ["VEHICLES_MEDIUM", 1, 50], ["VEHICLES_HEAVY", 1, 37], ["VEHICLES_AA_LIGHT", 1, 40]]];
	};
	case (_value > 400 && _value <= 450) : {
		_pool_units = [[["SOLDIER", 5], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 4, 37], ["SOLDIERS_AT_MEDIUM", 4, 82], ["SOLDIERS_AT_HEAVY", 4, 75], ["SOLDIER_AA", 2], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 4], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 2], ["SOLDIERS_SNIPERS", 3]], [["VEHICLES_LIGHT", 2, 60], ["VEHICLES_MEDIUM", 1, 55], ["VEHICLES_HEAVY", 1, 40], ["VEHICLES_AA_LIGHT", 1, 40]]];
	};
	case (_value > 450 && _value <= 500) : {
		_pool_units = [[["SOLDIER", 6], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 4, 35], ["SOLDIERS_AT_MEDIUM", 4, 84], ["SOLDIERS_AT_HEAVY", 4, 75], ["SOLDIER_AA", 2], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 4], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 2], ["SOLDIERS_SNIPERS", 4]], [["VEHICLES_LIGHT", 3, 60], ["VEHICLES_MEDIUM", 2, 65], ["VEHICLES_HEAVY", 2, 42], ["VEHICLES_AA_LIGHT", 2, 60]]];
	};
	case (_value > 500) : {
