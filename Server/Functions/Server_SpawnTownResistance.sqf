...
switch (true) do {
	...
	case (_value > 100 && _value <= 150) : {
		_pool_units = [[["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 2, 70], ["GUER_SOLDIERS_AT_HEAVY", 2, 70], ["GUER_SOLDIER_AA", 1, 25], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1, 70], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_VEHICLES_LIGHT", 1, 75], ["GUER_SOLDIERS_SNIPERS", 1, 75]], [["GUER_VEHICLES_MEDIUM", 1, 20], ["GUER_VEHICLES_AA_LIGHT", 1, 10]]];
	};
	case (_value > 150 && _value <= 200) : {
		_pool_units = [[["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 2, 75], ["GUER_SOLDIERS_AT_MEDIUM", 2, 75], ["GUER_SOLDIERS_AT_HEAVY", 2, 75], ["GUER_SOLDIER_AA", 1, 30], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1, 80]], [["GUER_VEHICLES_LIGHT", 1, 70], ["GUER_VEHICLES_MEDIUM", 1, 25], ["GUER_VEHICLES_AA_LIGHT", 1, 15]]];
	};
	case (_value > 200 && _value <= 250) : {
		_pool_units = [[["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 2, 80], ["GUER_SOLDIERS_AT_MEDIUM", 2, 80], ["GUER_SOLDIERS_AT_HEAVY", 2, 80], ["GUER_SOLDIER_AA", 1, 35], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1, 85]], [["GUER_VEHICLES_LIGHT", 1, 65], ["GUER_VEHICLES_MEDIUM", 1, 30], ["GUER_VEHICLES_AA_LIGHT", 1, 25]]];
	};
	case (_value > 250 && _value <= 300) : {
		_pool_units = [[["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 2, 85], ["GUER_SOLDIERS_AT_MEDIUM", 2, 85], ["GUER_SOLDIERS_AT_HEAVY", 2, 85], ["GUER_SOLDIER_AA", 1, 40], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1, 90]],[ ["GUER_VEHICLES_LIGHT", 1, 65], ["GUER_VEHICLES_MEDIUM", 1, 45], ["GUER_VEHICLES_AA_LIGHT", 1, 30]]];
	};
	case (_value > 300 && _value <= 350) : {
		_pool_units = [[["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 3, 90], ["GUER_SOLDIERS_AT_MEDIUM", 3, 90], ["GUER_SOLDIERS_AT_HEAVY", 3, 90], ["GUER_SOLDIER_AA", 1, 45], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1, 95]],[ ["GUER_VEHICLES_LIGHT", 1, 60], ["GUER_VEHICLES_MEDIUM", 1, 50], ["GUER_VEHICLES_AA_LIGHT", 1, 35]]];
	};
	case (_value > 350 && _value <= 400) : {
		_pool_units = [[["GUER_SOLDIER", 4], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 3, 95], ["GUER_SOLDIERS_AT_MEDIUM", 3, 95], ["GUER_SOLDIERS_AT_HEAVY", 3, 95], ["GUER_SOLDIER_AA", 1, 50], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 3], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 2]], [["GUER_VEHICLES_LIGHT", 2, 55], ["GUER_VEHICLES_MEDIUM", 1, 50],["GUER_VEHICLES_AA_LIGHT", 1, 40]]];
	};
	case (_value > 400 && _value <= 450) : {
		_pool_units = [[["GUER_SOLDIER", 5], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 4, 99], ["GUER_SOLDIERS_AT_MEDIUM", 4, 99], ["GUER_SOLDIERS_AT_HEAVY", 4, 99], ["GUER_SOLDIER_AA", 2, 55], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 4], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 2], ["GUER_SOLDIERS_SNIPERS", 3]],[ ["GUER_VEHICLES_LIGHT", 2, 60], ["GUER_VEHICLES_MEDIUM", 2, 55], ["GUER_VEHICLES_AA_LIGHT", 1, 45]]];
	};
	case (_value > 450 && _value <= 500) : {
		_pool_units = [[["GUER_SOLDIER", 6], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 4, 99], ["GUER_SOLDIERS_AT_MEDIUM", 4, 99], ["GUER_SOLDIERS_AT_HEAVY", 4, 99], ["GUER_SOLDIER_AA", 2, 60], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 4], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 2], ["GUER_SOLDIERS_SNIPERS", 4]],[["GUER_VEHICLES_LIGHT", 3, 60], ["GUER_VEHICLES_MEDIUM", 2, 65], ["GUER_VEHICLES_HEAVY", 2, 35], ["GUER_VEHICLES_AA_LIGHT", 2, 60]]];
	};
	case (_value > 500) : {
		_pool_units = [[["GUER_NAVAL_INFANTRY", 0, 01], ["GUER_NAVAL_BOATS", 6, 95], ["GUER_NAVAL_ASSAULT_BOATS", 8, 95]]];
	};
};
